...
email1 = Email.create(recipients_array: 'ftquixada@gmail.com', value: 0.01, day_of_month: '3', company_id: comp1.id, body: 'Prezados, até.')
email2 = Email.create(recipients_array: 'ftquixada@gmail.com', value: 0.00, day_of_month: '28', company_id: comp2.id, body: 'Prezados, até.')
email3 = Email.create(recipients_array: 'ftquixada@gmail.com', value: 12.33, day_of_month: '15', company_id: comp3.id, body: 'Prezados, até.')
email4 = Email.create(recipients_array: 'ftquixada@gmail.com', value: 10000.00, day_of_month: '4', company_id: comp4.id, body: 'Prezados, até.')
email5 = Email.create(recipients_array: 'ftquixada@gmail.com', value: 333.33, day_of_month: '18', company_id: comp4.id, body: 'Prezados, até.', active: false)
email6 = Email.create(recipients_array: 'ftquixada@gmail.com', value: 114.88, day_of_month: '21', company_id: comp5.id, body: 'Prezados, até.')
email7 = Email.create(recipients_array: 'ftquixada@gmail.com', value: 1743.00, day_of_month: '7', company_id: comp6.id, body: 'Prezados, até.', active: false)