...
user1 = User.create({name: "Sistema",     email: "apoioaoqueimado@yahoo.com.br", password: "fulano0123", password_confirmation: "fulano0123", bcc: 'teste@test.com', signature: '(Assinatura)', role: role1})
user2 = User.create({name: "Fabiow",      email: "ftquixada@gmail.com", password: "fulano0123", password_confirmation: "fulano0123", bcc: 'teste@test.com', signature: '(Assinatura)', role: role1})
...
user4 = User.create({name: "Edmar",       email: "edmarmaciel@gmail.com", password: "35348", password_confirmation: "35348", bcc: 'teste@test.com', signature: '(Assinatura)', role: role3})
user5 = User.create({name: "Márcia",       email: "marciattm@hotmail.com", password: "34533", password_confirmation: "34533", bcc: 'teste@test.com', signature: '(Assinatura)', role: role3})
user6 = User.create({name: "Renata",       email: "renata.sbq@gmail.com", password: "46486", password_confirmation: "46486", bcc: 'teste@test.com', signature: '(Assinatura)', role: role4})
user7 = User.create({name: "Lucivânia",   email: "lucivania_nojosa@hotmail.com", password: "23425", password_confirmation: "23425", bcc: 'teste@test.com', signature: '(Assinatura)', role: role5})
