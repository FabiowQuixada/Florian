...
when 'development', 'test', 'showcase' then
  ...
  Company.create(entity_type: Company.entity_types[:"Pessoa Jurídica"], name: 'Empresa III', registration_name: 'Empresa III Ltda.', cnpj: '01.476.667/0001-28', category: Company.categories[:"1 (Abaixo de R$ 300,00)"], address: 'lala', group: Company.groups[:Mantenedora])
  Company.create(entity_type: Company.entity_types[:"Pessoa Jurídica"], name: 'Empresa IV', registration_name: 'Empresa IV Ltda.', cnpj: '46.426.366/0001-28', category: Company.categories[:"2 (Entre R$ 300,00 e R$ 600,00)"], address: 'lala', group: Company.groups[:Mantenedora])
  Company.create(entity_type: Company.entity_types[:"Pessoa Jurídica"], name: 'Empresa V', registration_name: 'Empresa V Ltda.', cnpj: '01.302.458/0001-68', category: Company.categories[:"2 (Entre R$ 300,00 e R$ 600,00)"], address: 'lala', group: Company.groups[:Mantenedora])
  Company.create(entity_type: Company.entity_types[:"Pessoa Jurídica"], name: 'Empresa VI', registration_name: 'Empresa VI Ltda.', cnpj: '47.461.434/0001-52', category: Company.categories[:"1 (Abaixo de R$ 300,00)"], address: 'lala', group: Company.groups[:Mantenedora])
